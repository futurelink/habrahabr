 ...
 */
class MyServletContainer extends Container {
    ...
    private final ServletModule module = new ServletModule() {
        ...
        public String getContextPath() {
            ...
            throw new WebServiceException("Container "+MyServletContainer.class.getName()+" doesn't support getContextPath()");
        }
    };
    ...
    MyServletContainer(ServletContext servletContext) {
