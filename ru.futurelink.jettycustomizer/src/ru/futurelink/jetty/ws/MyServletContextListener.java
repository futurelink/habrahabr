...
public final class MyServletContextListener
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ...
            MyDeploymentDescriptorParser<ServletAdapter> parser = new MyDeploymentDescriptorParser<ServletAdapter>(
                classLoader,new MyServletResourceLoader(context), createContainer(context), new ServletAdapterList(context));
        			
            URL sunJaxWsXml = getClass().getResource(JAXWS_RI_RUNTIME);
            if(sunJaxWsXml==null)
    ...
    protected Container createContainer(ServletContext context) {
        return new MyServletContainer(context);
    }
    ...
    private static final String JAXWS_RI_RUNTIME = "/META-INF/sun-jaxws.xml";
