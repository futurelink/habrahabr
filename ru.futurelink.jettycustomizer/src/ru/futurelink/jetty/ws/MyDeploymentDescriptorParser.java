 ...
 */
public class MyDeploymentDescriptorParser<A> {
     ...
     */
    public MyDeploymentDescriptorParser(ClassLoader cl, ResourceLoader loader, Container container, AdapterFactory<A> factory) throws MalformedURLException {
        classLoader = cl;
        this.loader = loader;
     ...
     */
    /*public static interface AdapterFactory<A> extends com.sun.xml.ws.transport.http.DeploymentDescriptorParser.AdapterFactory<A> {
